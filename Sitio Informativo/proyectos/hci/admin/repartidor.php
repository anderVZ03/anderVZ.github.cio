...
<head>
    ...
    <link rel="stylesheet" href="/admin/css/repartidor.css">
    ...
    <div id="modal-agregar" class="modal">
        <div class="modal-contenido">
            ...
            <form id="formulario-agregar-cocinero" method="post" action="php/registrar_usuario.php" enctype="multipart/form-data">
                ...
                <input type="text" name="apellido" id="Apellido" placeholder="Número de Repartidor" required>
                <input type="text" name="usuario" id="usuario_editar" placeholder="Usuario" required>
                ...
                <input type="hidden" name="nivel" value="2"> <!-- Campo hidden para el nivel -->
        ...
        <div class="table-responsive">
                <?php
                    ...
                    if (isset($_SESSION['id_administrador'])) {
                        ...
                        $sql = "SELECT idCliente, nombre, apellido, fechaNacimiento, usuario,telefono, contrasena, direccion FROM cliente WHERE nivel = ?";
                        $consulta = $conexion->prepare($sql);
                        $nivel = 2; // Nivel 1 para cocineros
                        ...
                        <tbody>';    
                            ...
                            echo 'No hay registros de Repartidores.';
                        }
