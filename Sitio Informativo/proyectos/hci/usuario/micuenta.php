...
<body>
        ...
        <div class="user-profile">
            <div class="profile-image">
                ...
                <span id="profilePic" contenteditable="false">
                    <img src="images/perfiles/<?php echo $nombre;?>.jpg" alt="Foto de perfil" id="profileImage">
                </span>
    ...
    <p><i class="fas fa-user"></i> Apellido: <span id="apellido" class="editable" contenteditable="false"><?php echo $apellido; ?></span></p>
    <p><i class="fas fa-calendar-alt"></i> Fecha de Nacimiento: <span id="dob" class="editable" contenteditable="false"><?php echo $fechaNacimiento; ?></span></p>
    ...
    <div class="orders-container">
        <button class="orders-button" data-id="<?php echo $id_cliente; ?>">
            Ver Historial
        </button>
