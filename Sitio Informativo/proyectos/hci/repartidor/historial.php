...
<head>
    ...
    <link rel="stylesheet" href="/repartidor/css/historial.css">
...
if (isset($_SESSION['id_repartidor'])) {
    ...
    $sql = "SELECT f.idFactura, f.fecha, f.total, f.direccion, c.nombre AS nombreCliente, c.apellido AS apellidoCliente
            ...
            WHERE f.estadoEntrega = true"; // Cambia el estado según tus necesidades
...
<div class="modal-contenido">
    ...
    <button  id="confirmarEntrega" style="display: none;" onclick="confirmarEntrega()"></button>
