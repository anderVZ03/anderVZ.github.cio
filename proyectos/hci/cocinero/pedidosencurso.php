...
<body>
    ...
    <div class="orders-container" id="ordersContainer">
        ...
        <?php
            ...
            $sql = "SELECT idFactura, fecha, total, direccion FROM factura WHERE estado = false";
            ...
            if ($resultadoFacturas->num_rows > 0) {
                while ($factura = $resultadoFacturas->fetch_assoc()) {
                    ...
                    echo '<button class="ready-button" data-order-id="' . $idFactura . '">Marcar como Listo</button>';
                    echo '</div>';
                    $fac = intval($idFactura);
                    ...
                    $consultaProductos->bind_param("i", $fac);
