<?php
                ...
                if (isset($_SESSION['id_cocinero'])){
                        $id_cliente = $_SESSION['id_cocinero'];
                        include("../db.php");
...
<body>
    ...
    <p><i class="fas fa-user"></i> Sección: <span id="apellido" class="editable" contenteditable="false"><?php echo $apellido; ?></span></p>
    <p><i class="fas fa-calendar-alt"></i> Fecha de apertura: <span id="dob" class="editable" contenteditable="false"><?php echo $fechaNacimiento; ?></span></p>
